...
CLASSES = [
    ...
    ("String / data encryption",  r"string\s*(encrypt|obfusc|encod)|encrypted string|\bxor\b|rc4|encrypted data|data encrypt|cipher|base\s*64|base64|base32|hex encod|rot13"),
